...
namespace Pacman
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        int spriteDirection = 1; // Starts pacman facing right
        int spriteX = 66;  // Starting positions for the Pacman character
        int spriteY = 159;  // (just above the ghost's door!!!! :)
        int moveY = 0;
        int moveX = 0;
        ...
        void CreateOutOfBounds()
        {
            ...
            rects[0] = new Rectangle(19, 49, 3, 222); //boundary OOB
            rects[1] = new Rectangle(19, 267, 84, 3);
            rects[2] = new Rectangle(19, 49, 84, 3);
            rects[3] = new Rectangle(57, 49, 6, 20);
            rects[4] = new Rectangle(57, 250, 6, 20);
            rects[5] = new Rectangle(99, 227, 28, 44);
            rects[6] = new Rectangle(99, 49, 28, 44);
            rects[7] = new Rectangle(99, 89, 28, 3);
            rects[8] = new Rectangle(99, 226, 29, 3);
            rects[9] = new Rectangle(124, 226, 3, 44);
            rects[10] = new Rectangle(124, 49, 3, 44);
            rects[11] = new Rectangle(141, 49, 28, 44);
            rects[12] = new Rectangle(141, 226, 3, 44);
            rects[13] = new Rectangle(141, 89, 28, 3);
            rects[14] = new Rectangle(141, 226, 28, 3);
            rects[15] = new Rectangle(166, 49, 3, 44);
            rects[16] = new Rectangle(166, 226, 3, 44);
            rects[17] = new Rectangle(166, 49, 70, 3);
            rects[18] = new Rectangle(166, 266, 70, 3);
            rects[19] = new Rectangle(232, 49, 3, 221);
            rects[20] = new Rectangle(204, 155, 32, 10);
            rects[21] = new Rectangle(36, 66, 6, 75); //Inside OOB
            rects[22] = new Rectangle(36, 106, 27, 10);
            rects[23] = new Rectangle(36, 154, 27, 10);
            rects[24] = new Rectangle(57, 130, 6, 59);
            rects[25] = new Rectangle(36, 178, 6, 75);
            rects[26] = new Rectangle(78, 66, 6, 27);
            rects[27] = new Rectangle(57, 82, 27, 10);
            rects[28] = new Rectangle(78, 106, 6, 35);
            rects[29] = new Rectangle(99, 130, 6, 59);
            rects[30] = new Rectangle(78, 178, 6, 35);
            rects[31] = new Rectangle(57, 226, 27, 10);
            rects[32] = new Rectangle(78, 226, 6, 27);
            rects[33] = new Rectangle(99, 106, 27, 10);
            rects[34] = new Rectangle(99, 202, 27, 10);
            rects[35] = new Rectangle(141, 106, 49, 10);
            rects[36] = new Rectangle(162, 106, 6, 35);
            rects[37] = new Rectangle(162, 154, 27, 10);
            rects[38] = new Rectangle(183, 130, 6, 59);
            rects[39] = new Rectangle(162, 178, 6, 35);
            rects[40] = new Rectangle(141, 202, 49, 10);
            rects[41] = new Rectangle(183, 226, 6, 27);
            rects[42] = new Rectangle(204, 66, 14, 27);
            rects[43] = new Rectangle(204, 106, 14, 35);
            rects[44] = new Rectangle(204, 178, 14, 35);
            rects[45] = new Rectangle(204, 226, 14, 27);
            rects[46] = new Rectangle(120, 130, 28, 4); //Ghost Pen OOB
            rects[47] = new Rectangle(145, 130, 3, 23);
            rects[48] = new Rectangle(145, 167, 3, 22);
            rects[49] = new Rectangle(120, 185, 28, 4);
            rects[50] = new Rectangle(120, 130, 3, 59);
            rects[51] = new Rectangle(146, 153, 2, 14); // this is the door! not done

            tunnel1 = new Rectangle(127, 49, 14, 2);  //not done
            tunnel2 = new Rectangle(127, 269, 14, 2);  //not done
            closedoor = new Rectangle(146, 153, 2, 14); //not done

        }

        void CreatePoints()
        {
            noPts = 783; // 26 * 27 [grid of points]
            ...
            for (int i = 0; i < 29; i++)
            {
                for (int j = 0; j < 27; j++)
                {
                    ...
                    Rectangle tempRect = new Rectangle(x + (j * 10), y + (i * 10), 2, 2);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (forced == true)
            {
                ...
                if (shutDoor == true)
                {
                    ...
                    rects[54] = new Rectangle(146, 153, 2, 14); // shuts the door
        ...
        void MoveGhosts()
        {
            ...
            for (int i = 0; i < noGhosts; i++)
            {
                if (forceGhosts[i] == true)
                {
                    if ((ghostY[i] > doorLeft) && (ghostX[i] + ghost.Width < doorLeft + doorWidth))
                    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < noGhosts; i++)
            {
                ...
                spriteBatch.Draw(ghostEye, new Rectangle(ghostX[i] + 8, ghostY[i] + 5, ghostEye.Width, ghostEye.Height), Color.White);
                spriteBatch.Draw(ghostEye, new Rectangle(ghostX[i] + 8, ghostY[i] + 10, ghostEye.Width, ghostEye.Height), Color.White);

                if ((ghostLastDirection[i] == 0) || (ghostLastDirection[i] == -1)) // up (or starting)
                {
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 9, ghostY[i] + 5, ghostPupil.Width, ghostPupil.Height), Color.White);
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 9, ghostY[i] + 10, ghostPupil.Width, ghostPupil.Height), Color.White);
                }

                if (ghostLastDirection[i] == 1) // down
                {
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 6, ghostY[i] + 5, ghostPupil.Width, ghostPupil.Height), Color.White);
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 6, ghostY[i] + 10, ghostPupil.Width, ghostPupil.Height), Color.White);
                }

                if (ghostLastDirection[i] == 2) // left
                {
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 8, ghostY[i] + 3, ghostPupil.Width, ghostPupil.Height), Color.White);
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 8, ghostY[i] + 8, ghostPupil.Width, ghostPupil.Height), Color.White);
                }

                if (ghostLastDirection[i] == 3) // right
                {
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 8, ghostY[i] + 7, ghostPupil.Width, ghostPupil.Height), Color.White);
                    spriteBatch.Draw(ghostPupil, new Rectangle(ghostX[i] + 8, ghostY[i] + 12, ghostPupil.Width, ghostPupil.Height), Color.White);
                }
